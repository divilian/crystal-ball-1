...
% TODO: maybe move this section to its own chapter, after the two functions
% ones? After all, it often makes sense to use a function to perform the
% recoding for a single row.
