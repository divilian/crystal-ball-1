...
value, that new value would \textit{replace} her current value, not sit
...
columns in the rotunda in James Farmer Hall.) Also, the typical table has many,
many more rows than columns, so they're super tall and skinny, not short and
fat.
